...
%
% This template has been downloaded from: https://github.com/Lilinowaytogo/Latex-Cheinese-CV-Resume-Template/tree/main
% 
%
% Author:
...
%\input{resume/个人简介.tex}
\input{resume/教育经历.tex}
\input{resume/项目经历.tex}
\input{resume/技能.tex}
\input{resume/语言.tex}
\input{resume/成就.tex}
\input{resume/实习经历.tex}
\input{resume/发表期刊论文.tex}
%\input{resume/职位.tex}
%\input{resume/参与组织活动.tex}
